...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui-vercel/card"
import { AlertCircle } from "lucide-react"
import { Alert, AlertDescription } from "@/components/ui-vercel/alert"
...
export const SignUpCard = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // For demo purposes, just navigate to dashboard after a delay
      setTimeout(() => {
